...
@property (nonatomic, copy) NSString *tgusetcode;
...
@property (nonatomic, copy) NSString *tgusetadbox;
...
@property (nonatomic, copy) NSString *enterprisedatetime;
@property (nonatomic, copy) NSString *enterpriseidtguset;
@property (nonatomic, copy) NSString *enterpriseimgname;
@property (nonatomic, copy) NSString *enterpriseimgtype;
