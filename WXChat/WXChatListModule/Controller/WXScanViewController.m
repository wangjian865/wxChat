...
- (void)viewDidLoad {
    ...
    UIButton * photoBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 80, k_top_height/2, 64, k_top_height/2)];
    ...
    _scanView.myQRCodeBlock = ^{
        ...
        createQRCodeController.qrImage =  [WSLNativeScanTool createQRCodeImageWithString:@"https://www.baidu.com" andSize:CGSizeMake(250, 250) andBackColor:[UIColor whiteColor] andFrontColor:[UIColor orangeColor] andCenterImage:[UIImage imageNamed:@"piao"]];
        createQRCodeController.qrString = @"https://www.baidu.com";
